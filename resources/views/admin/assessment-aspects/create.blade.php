        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form Tambah Aspek Penilaian</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form class="form form-vertical" method="POST"
                            action="{{ route('admin.assessment-aspects.store') }}">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            @php
                                                $selectedSubCriteriaId = old(
                                                    'sub_criteria_id',
                                                    request('sub_criteria_id'),
                                                );
                                            @endphp
                                            <select id="sub_criteria_id" name="sub_criteria_id"
                                                ...
                                                @foreach ($subCriterias as $subCriteria)
                                                    <option value="{{ $subCriteria->id }}" @selected((int) $selectedSubCriteriaId === $subCriteria->id)>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                                rows="3" placeholder="Masukkan deskripsi aspek (opsional)">{{ old('description') }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
