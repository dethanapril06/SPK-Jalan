                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="alert alert-light-info color-info" role="alert">
                            Password user akan otomatis dibuat dengan default: <strong>password</strong>
                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                placeholder="Masukkan nama user" id="name" name="name"
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select id="role" name="role"
                                                ...
                                                <option value="kepala_dinas" @selected(old('role') === 'kepala_dinas')>Kepala Dinas
                                                </option>
                                            </select>
                                            @error('role')
                                                <div class="invalid-feedback">{{ $message }}</div>
