                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('kepala-dinas.mfep.ranking') }}">Ranking MFEP</a>
                            </li>
        ...
        <section class="section">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered align-middle mb-0">
                        <tbody>
                            ...
                            <tr>
                                <th>Status</th>
                                <td><span class="badge bg-success">{{ ucfirst($calculation->status) }}</span></td>
                            </tr>
                            <tr>
            ...
            <div>
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="{{ route('kepala-dinas.mfep.pdf', $calculation->id) }}" class="btn btn-danger btn-sm">
                    ...
                    <table class="table table-bordered table-striped align-middle mfep-detail-table">
                        <thead>
                            <tr>
                                ...
                                <th class="text-end" style="width: 110px;">E x W</th>
                                ...
                                @if ($details->isNotEmpty())
                                    @foreach ($details as $detail)
                                        <tr class="criteria-divider">
                                            ...
                                            <td class="text-center">
                                                {{ number_format((float) $detail->weight, 2, ',', '.') }}</td>
                                            <td class="text-end">
                                ...
                                @else
                                    <tr>
                                        ...
                                        <td class="text-end fw-bold">
                                            {{ number_format((float) $result->weighted_score, 4, ',', '.') }}</td>
                                        <td>
                                            @if ($result->is_recommended)
                                                <span class="badge bg-success">Rekomendasi</span>
                                            @else
            ...
            <div class="row mt-3">
                <div class="col-12">
                    <a href="{{ route('kepala-dinas.mfep.ranking', ['calculation_id' => $calculation->id]) }}"
