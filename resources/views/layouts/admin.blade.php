...
<body>
            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ request()->routeIs('admin.mfep.*') ? 'active' : '' }}">
                            <a href="{{ route('admin.mfep.ranking') }}" class="sidebar-link">
                        ...
                        <li class="sidebar-item {{ request()->routeIs('admin.sub-criteria.*') ? 'active' : '' }}">
                            <a href="{{ route('admin.sub-criteria.index') }}" class="sidebar-link">
                        ...
                        <li
                            class="sidebar-item {{ request()->routeIs('admin.assessment-aspects.*') ? 'active' : '' }}">
                            <a href="{{ route('admin.assessment-aspects.index') }}" class="sidebar-link">
                                <i class="bi bi-card-checklist"></i>
                                <span>Aspek Penilaian</span>
                            </a>
                        </li>

                        <li class="sidebar-item {{ request()->routeIs('admin.alternatives.*') ? 'active' : '' }}">
                            <a href="{{ route('admin.alternatives.index') }}" class="sidebar-link">
                                <i class="bi bi-signpost-split-fill"></i>
                                <span>Alternatif</span>
                            </a>
                        </li>

                        <li class="sidebar-item {{ request()->routeIs('admin.assignments.*') ? 'active' : '' }}">
                            <a href="{{ route('admin.assignments.index') }}" class="sidebar-link">
                                <i class="bi bi-clipboard-check-fill"></i>
                                <span>Penugasan</span>
                            </a>
                        </li>

                        <li class="sidebar-item {{ request()->routeIs('admin.reports.assessments') ? 'active' : '' }}">
                            <a href="{{ route('admin.reports.assessments') }}" class="sidebar-link">
                        ...
                        <li class="sidebar-item {{ request()->routeIs('admin.surveyors.*') ? 'active' : '' }}">
                            <a href="{{ route('admin.surveyors.index') }}" class="sidebar-link">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('admin.dashboard') }}"><i
                                                class="icon-mid bi bi-grid-fill me-2"></i>
                                            Dashboard</a>
                                    </li>
                                    <li>
    ...
    <script>
        // SweetAlert2 confirmation untuk delete forms
