            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ request()->routeIs('surveyor.dashboard') ? 'active' : '' }}">
                            <a href="{{ route('surveyor.dashboard') }}" class="sidebar-link">
                        ...
                        <li
                            class="sidebar-item {{ request()->routeIs('surveyor.task.show') || request()->routeIs('surveyor.assessments.*') ? 'active' : '' }}">
                            <a href="{{ route('surveyor.dashboard') }}" class="sidebar-link">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('surveyor.dashboard') }}"><i
