@php
    ...
    $layout = match($role) {
        'admin'       => 'layouts.admin',
        'kepala_dinas'=> 'layouts.kepala-dinas',
        'surveyor'    => 'layouts.surveyor',
                ...
                <div class="card">
                    <div class="card-body text-center py-5">
                        @php
                            ...
                            $avatarUrl = 'https://ui-avatars.com/api/?name=' . urlencode($name) . '&background=435ebe&color=fff&size=128&bold=true&font-size=0.4';
                        @endphp
